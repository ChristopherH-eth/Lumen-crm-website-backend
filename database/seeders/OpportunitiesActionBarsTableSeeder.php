...
class OpportunitiesActionBarsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        // Default action bar for Opportunity collections
        ...
        // Default action bar for Opportunity entries
        ...
        DB::table('opportunities_action_bars')->insert([
            [
