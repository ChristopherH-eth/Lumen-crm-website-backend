...
class AccountsActionBarsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        // Default action bar for Account collections
        ...
        // Default action bar for Account entries
        ...
        DB::table('accounts_action_bars')->insert([
            [
